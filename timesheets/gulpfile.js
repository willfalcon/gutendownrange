...
gulp.task('dev_styles', () => {
  ...
  .pipe(concat('timesheets.min.css'))
...
gulp.task('dev_scripts',() => {
  ...
  return browserify({
    entries: ['./src/timesheets.js'],
    debug: true
  })
    .bundle()
    //Pass desired output filename to vinyl-source-stream
    .pipe(source('timesheets.min.js'))
    .pipe(buffer())
...
gulp.task('watch', () => {
  ...
  // Watch .scss files
  gulp.watch('src/**/*.scss', ['dev_styles']);

  // Watch .js files
  gulp.watch('src/**/*.js', ['dev_scripts']);
